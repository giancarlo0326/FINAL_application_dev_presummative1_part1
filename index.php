...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #2126ad;">
        <div class="container">
        ...
        <div class="row">
            <?php foreach ($_SESSION['data'] as $entry): ?>
                <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center">
                    <div class="card bg-dark text-white mb-3" style="background-color: #2126ad;">
                        <img src="<?php echo $entry['image_path']; ?>" class="card-img-top" alt="Image" style="background-color: #2126ad;">
                        <div class="card-body" style="background-color: #2126ad;">
